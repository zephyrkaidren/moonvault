...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-xs bg-paper-light rounded-lg p-7 border border-ink/10">
      <form onSubmit={handleSubmit}>
        <h1 className="font-display font-semibold text-lg mb-1">Moonvault</h1>
        <p className="text-sm text-slate mb-5">Welcome back.</p>
